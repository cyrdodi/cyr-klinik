...
<head>
	...
	<link rel='stylesheet' type='text/css' href='<?= base_url('assets/') ?>css/eb-style.css' />
	<link rel='stylesheet' type='text/css' href='<?= base_url('assets/') ?>css/eb-print.css' media="print" />
...
<body>
	...
	<div id="page-wrap">
		...
		<div id="identity">
			...
			<div id="logo">
				<img id="image" src="images/logo-by.png" alt="logo" style="width: 100px" />
			</div>
		...
		<div id="customer">
			...
			<textarea id="customer-title">Klinik Bhakti Yuana
